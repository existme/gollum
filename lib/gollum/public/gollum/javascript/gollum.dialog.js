...
(function($) {
  ...
  var Dialog = {
    ...
    attachEvents: function( evtOK ) {
      ...
      $('#gollum-dialog-dialog').bind('keydown', function( e ) {
        if ( e.keyCode == 27 ) {
          Dialog.eventCancel( e );
        }
      });
    },
    ...
    detachEvents: function() {
      ...
      $('#gollum-dialog-dialog input[type="text"]').unbind('keydown');
      $('#gollum-dialog-dialog').unbind('keydown');
    },
